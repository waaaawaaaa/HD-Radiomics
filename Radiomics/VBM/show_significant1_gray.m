...
%         sig_hot = ind2rgb(uint8(rescale(sig_combined_normalized) * 255), hot(256)); % 使用 hot 颜色映射
        sig_hot = cat(3, uint8(rescale(sig_combined_normalized) * 255), uint8(rescale(sig_combined_normalized) * 255), uint8(rescale(sig_combined_normalized) * 255));
